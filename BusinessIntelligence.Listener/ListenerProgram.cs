...
namespace BusinessIntelligence
{
    class ListenerProgram
    {
        ...
        static void Main(string[] args)
        {
            ...
            RunAs.Authentication.AuthenticateAndRecall(RunAs.ApplicationInterfaceType.Console, Environment.CommandLine);
            ...
            while (true)
            {
                ...
                Log.WriteLine(DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + " Waiting " + secondsToWait.ToString() + " seconds...");
