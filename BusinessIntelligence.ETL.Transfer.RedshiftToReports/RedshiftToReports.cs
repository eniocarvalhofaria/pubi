    ...
    class RedshiftToReports
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                var loader = new SqlServerLoader(Connections.GetNewConnection("REPORTS"), schemaName, options.TableName);
                var transfer = new DataTransfer(Connections.GetNewConnection("REDSHIFT"), options.ReadCommand, loader);
