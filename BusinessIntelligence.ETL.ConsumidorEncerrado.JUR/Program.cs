...
namespace BusinessIntelligence.ETL.ConsumidorEncerrado.JUR
{
         ...
         try
           {
            ...
            dt.Columns.Add("Tipo_Encerramento", typeof(string));
            dt.Columns.Add("Data_Baixa", typeof(string));
            dt.Columns.Add("Data_Encerramento", typeof(string));
            dt.Columns.Add("Valor_Total", typeof(string));
            dt.Columns.Add("Valor_Moral", typeof(string));
            dt.Columns.Add("valor_Material", typeof(string));
            dt.Columns.Add("Usuario_Encerramento", typeof(string));
            ...
            ex.Execute("delete from dbo.JUR_ConsumidorEncerrado_stage");
            ...
            {
                bc.DestinationTableName = "dbo.JUR_ConsumidorEncerrado_stage";
                bc.BatchSize = 10000;
            ...
            ex.Execute("exec  dbo.Refresh_JUR_ConsumidorEncerrado");
