...
namespace BusinessIntelligence.ETL.Juridico.REC
{
         ...
         try
           {
            ...
            ex.Execute("delete from dbo.REC_Juridico_stage");
            ...
            {
                bc.DestinationTableName = "dbo.REC_Juridico_stage";
                bc.BatchSize = 10000;
            ...
            ex.Execute("exec  dbo.Refresh_REC_Juridico");
